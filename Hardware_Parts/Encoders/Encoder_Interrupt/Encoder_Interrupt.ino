 ...
 * -In high speed scenarios where high frequency pulses occur 
 *  faster than the microcontroller can detect. If you require
 *  an even faster implementation I recommend the Encoder.h 
 *  library by Paul Stoffregen for those purposes.
 * 
 * This implementation requires 2 IO interrupt capable pins per 
 * rotary encoder.
 * 
 * by Adam Billingsley
 * created 12 Feb, 2023
